...
#include "../FilterIteratorConcepts/FilterIteratorConcepts.h"
#include "../FilterIteratorConcepts/Range.h"
...
public:
	...
	bool operator==(const IsGreaterTen& pred) { return *this == pred; }
};
...
public:
	bool operator()(int num) { return ten == num; }
	bool operator==(const IsTen& pred) { return *this == pred; }
};
...
public:
	...
	bool operator==(const IsMyNum& pred) { return *this == pred; }
};
