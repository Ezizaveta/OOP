...
concept ConvertibleToForwardIterator = std::is_convertible_v<
...
template<class T>
concept DefaultConstructibleClass = DefaultConstructible<T> && IsClass<T>;


template <class Predicate, ConvertibleToForwardIterator Iterator>
...
public:
    ...
    template<DefaultConstructibleClass P = Predicate, typename I = Iterator>
    filter_iterator(Iterator iter, Iterator end = Iterator()) :
...
template <DefaultConstructibleClass Predicate, class Iterator>
filter_iterator <Predicate, Iterator>
