...
void VecFreqDictionary::addWord(const std::string & word)
{
	if (!word.empty())
	{
...
bool VecFreqDictionary::ResetEnumerator()
{
	if (!Dictionary.empty())
	{
...
std::pair<std::string, size_t> VecFreqDictionary::getNext()
{
	if (Dictionary.empty())
	{
...
std::vector<std::pair<std::string, size_t>>::iterator VecFreqDictionary::findWord(const std::string & word)
{
	if (word.empty())
	{
